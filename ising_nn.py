...
if __name__ == '__main__':
    ...
    train_images, train_labels = np.array(train_images, dtype=np.float32), np.array(train_labels, dtype=np.int32)
    test_images, test_labels = np.array(test_images, dtype=np.float32), np.array(test_labels, dtype=np.int32)
